...
export const ExecutiveSummaryView = memo(
  ({
    ...
    const [showPropCoBreakdown, setShowPropCoBreakdown] =
    ...
    const currentBlendedIrr =
      rawIrr !== undefined ? `${(rawIrr * 100).toFixed(2)}%` : "18.58%";

    const rawPropCoCapex = propCoData?.metrics?.totalCapex;
    const currentPropCoCapexText =
      rawPropCoCapex !== undefined
        ? `IDR ${rawPropCoCapex.toFixed(1)} Billion`
        : "IDR 406.6 Billion";

    const rawOpCoEquity = opCoData?.totalEquity;
    const currentOpCoEquityText =
      rawOpCoEquity !== undefined
        ? `IDR ${rawOpCoEquity.toFixed(2)} Billion`
        : "IDR 82.17 Billion";

    const rawPayback = consolidatedData?.metrics?.payback;
    const currentPaybackText =
      rawPayback !== undefined
    ...
    const currentBedsText =
      opCoData?.opsMetrics?.beds !== undefined
        ? `${opCoData.opsMetrics.beds}-bed Capacity`
        : "120-bed Capacity";
    ...
    const narrativeSteps = [
        ...
        content: (
          <div className="space-y-3">
            <p className="text-sm text-[#4C4A4B] leading-relaxed">
              Robust clinical operations and defensive underwriting yield
              attractive base-case returns and durable risk covenants:
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
              <div className="p-3 bg-white rounded-lg border border-[#D8D8D8]/60">
                <span className="text-[9px] uppercase font-black text-[#1C6048] block mb-1">
                  Projected Base IRR
                </span>
                <p className="text-sm font-bold text-[#1E2F31] font-display">
                  {currentBlendedIrr}
                </p>
                <p className="text-[10px] text-[#4C4A4B] mt-0.5">
                  Blended portfolio equity yield post occupancy stabilization.
                </p>
              </div>
              <div className="p-3 bg-white rounded-lg border border-[#D8D8D8]/60">
                <span className="text-[9px] uppercase font-black text-[#9B8B70] block mb-1">
                  Payback Period
                </span>
                <p className="text-sm font-bold text-[#1E2F31] font-display">
                  {currentPaybackText}
                ...
                <p className="text-[10px] text-[#4C4A4B] mt-0.5">
                  Estimated time to recover the initial project investment
                  capital.
                </p>
              </div>
              <div className="p-3 bg-white rounded-lg border border-[#D8D8D8]/60">
                <span className="text-[9px] uppercase font-black text-[#1E2F31] block mb-1">
                  Exit Multiple
                </span>
                <p className="text-sm font-bold text-[#1E2F31] font-display">
                  15x EBITDA
                ...
                <p className="text-[10px] text-[#4C4A4B] mt-0.5">
                  Target sector multiple applied for terminal asset valuation.
                </p>
              </div>
            </div>
          </div>
        ...
        content: (
          <div className="space-y-4">
            <p className="text-xs text-[#4C4A4B] leading-relaxed">
              Targeting a severe supply-demand mismatch characterized by chronic
              bed shortages and qualitative capacity failures.
            </p>
            <div className="grid grid-cols-2 gap-3 pt-1">
              <div className="p-3 bg-white rounded-xl border border-[#D8D8D8]/60 flex flex-col justify-between">
                <span className="text-[9px] font-black uppercase text-[#1C6048] tracking-widest mb-1.5 block">
                  Bed Deficit
                </span>
                <div className="flex items-center gap-1.5">
                  <span className="text-xl font-black text-[#1E2F31]">1.4</span>
                  <span className="text-xs font-black text-[#1E2F31] opacity-50">
                    &lt;
                  </span>
                  <span className="text-xl font-black text-[#1C6048]">4.5</span>
                </div>
                <span className="text-[9px] text-[#8A8175] font-semibold mt-1">
                  Local vs. Global Avg (per 1,000 people)
                </span>
              </div>

              <div className="p-3 bg-white rounded-xl border border-[#D8D8D8]/60 flex flex-col justify-between">
                <span className="text-[9px] font-black uppercase text-[#9B8B70] tracking-widest mb-1.5 block">
                  Physician Ratio
                </span>
                <div className="flex items-baseline gap-1">
                  <span className="text-xl font-black text-[#1E2F31]">1</span>
                  <span className="text-lg font-black text-[#1E2F31] opacity-50">
                    :
                  </span>
                  <span className="text-xl font-black text-[#1E2F31]">
                    2000
                  </span>
                </div>
                <span className="text-[9px] text-[#8A8175] font-semibold mt-1">
              ...
              <div className="p-3 bg-white rounded-xl border border-[#D8D8D8]/60 flex flex-col justify-between">
                <span className="text-[9px] font-black uppercase text-[#2A4750] tracking-widest mb-1.5 block">
                  Quality Mismatch
                </span>
                <div className="flex flex-col mt-0.5">
                  <span className="text-sm font-black text-[#1E2F31] leading-tight">
                    High Cost
                  </span>
                  <span className="text-sm font-bold text-[#8A8175] leading-tight">
                    Non-Tier A Exp.
                  </span>
                </div>
                <span className="text-[9px] text-[#8A8175] font-semibold mt-2">
                  Structural value gap
                </span>
              </div>

              <div className="p-3 bg-white rounded-xl border border-[#D8D8D8]/60 flex flex-col justify-between">
                <span className="text-[9px] font-black uppercase text-[#1E2F31] tracking-widest mb-1.5 block">
                  Admin Bottleneck
                </span>
                <div className="flex items-baseline gap-1">
                  <span className="text-xl font-black text-[#1E2F31]">
                ...
                <span className="text-[9px] text-[#8A8175] font-semibold mt-1">
                  Average wait per patient visit
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <div className="p-2.5 bg-[#1C6048] rounded-lg border border-[#1C6048]">
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="text-[9px] uppercase font-black text-white tracking-wider">
                    West Jakarta
                  </span>
                </div>
                <p className="text-[10px] text-[#C4DFD2] font-semibold">
                  Daan Mogot
                </p>
              </div>
            ...
            <div className="bg-white p-4 rounded-xl border border-[#D8D8D8] space-y-4">
              <p className="text-xs font-semibold text-[#4C4A4B] leading-relaxed font-sans border-b border-[#D8D8D8]/50 pb-3">
                The dual-entity asset lease provides direct yield flow back to
              ...
              <div className="text-[10px] text-[#4C4A4B] leading-snug italic text-center opacity-90 pt-1">
                💡 PropCo collects stable yields on physical premises, while
                OpCo focuses purely on scaling primary patient care metrics.
              </div>
            </div>
          </div>
        ),
      },
      {
        ...
        subtitle:
          "Direct PropCo Development Budgets & Clinical OpCo Startup Capital",
        icon: <Building2 className="text-[#1C6048]" size={18} />,
        content: (
          <div className="space-y-4">
            <p className="text-sm text-[#4C4A4B] leading-relaxed">
              Capital requirements are segregated to match institutional
              developer criteria (PropCo Property assets) and clinical operator
              models (OpCo Startup capital):
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
              {/* PropCo Column */}
              <div className="p-4 bg-white rounded-xl border border-[#D8D8D8] flex flex-col justify-between h-full">
                <div className="flex-1">
                  <span className="text-[9px] uppercase font-black text-[#1E2F31] block mb-0.5">
                    PropCo Development CapEx
                  </span>
                  <p className="text-lg font-bold text-[#1E2F31] font-display mb-3">
                    {currentPropCoCapexText}
                  </p>
                  ...
                  <div className="border-t border-[#EFEBE7] pt-2 space-y-0.5 text-[10.5px] text-[#4C4A4B]">
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] p-1 rounded font-bold text-[#1E2F31]">
                      ...
                      <span className="text-right">
                        {propCoData?.capexDetails?.landCost !== undefined
                          ? propCoData.capexDetails.landCost.toFixed(1)
                          : "50.0"}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] p-1 rounded font-bold text-[#1E2F31] border-t border-[#EFEBE7]/50 pt-1 mt-1">
                      ...
                      <span className="text-right">
                        {propCoData?.capexDetails?.totalHardCosts !== undefined
                          ? propCoData.capexDetails.totalHardCosts.toFixed(1)
                          : "265.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      ...
                      <span className="text-right">
                        {propCoData?.capexDetails?.buildCost !== undefined
                          ? propCoData.capexDetails.buildCost.toFixed(1)
                          : "120.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      ...
                      <span className="text-right">
                        {propCoData?.capexDetails?.medEqCost !== undefined
                          ? propCoData.capexDetails.medEqCost.toFixed(1)
                          : "105.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      ...
                      <span className="text-right">
                        {propCoData?.capexDetails?.infraCost !== undefined
                          ? propCoData.capexDetails.infraCost.toFixed(1)
                          : "25.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      <span>• FF&E</span>
                      <span className="text-right">
                        {propCoData?.capexDetails?.ffeCost !== undefined
                          ? propCoData.capexDetails.ffeCost.toFixed(1)
                          : "10.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      ...
                      <span className="text-right">
                        {propCoData?.capexDetails?.sharingDevCost !== undefined
                          ? propCoData.capexDetails.sharingDevCost.toFixed(1)
                          : "5.0"}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] p-1 rounded font-bold text-[#1E2F31] border-t border-[#EFEBE7]/50 pt-1 mt-1">
                      ...
                      <span className="text-right">
                        {propCoData?.capexDetails?.totalSoftCosts !== undefined
                          ? propCoData.capexDetails.totalSoftCosts.toFixed(1)
                          : "80.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      ...
                      <span className="text-right">
                        {propCoData?.capexDetails?.consultantCost !== undefined
                          ? propCoData.capexDetails.consultantCost.toFixed(1)
                          : "15.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      <span>• License</span>
                      <span className="text-right">
                        {propCoData?.capexDetails?.licenseCost !== undefined
                          ? propCoData.capexDetails.licenseCost.toFixed(1)
                          : "5.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      <span>• VAT</span>
                      <span className="text-right">
                        {propCoData?.capexDetails?.vatCost !== undefined
                          ? propCoData.capexDetails.vatCost.toFixed(1)
                          : "30.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      ...
                      <span className="text-right">
                        {propCoData?.capexDetails?.contingencyCost !== undefined
                          ? propCoData.capexDetails.contingencyCost.toFixed(1)
                          : "15.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      <span>• Dev. G&A</span>
                      <span className="text-right">
                        {propCoData?.capexDetails?.devGaCost !== undefined
                          ? propCoData.capexDetails.devGaCost.toFixed(1)
                          : "10.0"}
                      </span>
                    </div>
                    <div className="flex justify-between font-display hover:bg-[#F9F8F6] py-0.5 px-2 rounded text-[#6E6C6D]">
                      <span>• Dev. CAR</span>
                      <span className="text-right">
                        {propCoData?.capexDetails?.devCarCost !== undefined
                          ? propCoData.capexDetails.devCarCost.toFixed(1)
                          : "5.0"}
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex justify-between font-display hover:bg-[#1E2F31]/5 p-1 rounded border-t border-[#1E2F31]/20 pt-1.5 mt-3 text-[#1E2F31] font-black uppercase text-[10px]">
                  ...
                  <span className="text-right">
                    {propCoData?.metrics?.totalCapex !== undefined
                      ? propCoData.metrics.totalCapex.toFixed(1)
                      : "395.0"}
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 h-full">
                ...
                <div className="p-3.5 bg-white rounded-xl border border-[#D8D8D8] flex flex-col justify-between flex-1">
                  <div className="flex-1">
                    <div className="flex justify-between items-start mb-1">
                      <div>
                        <span className="text-[9px] uppercase font-black text-[#1C6048] block mb-0.5">
                          OpCo Startup Capital
                        </span>
                        <p className="text-lg font-bold text-[#1C6048] font-display">
                    ...
                    <div className="border-t border-[#EFEBE7] pt-2 mt-1 space-y-1 text-[10px] text-[#4C4A4B]">
                      <div className="flex justify-between font-display hover:bg-[#F9F8F6] p-0.5 px-1 rounded">
                        <span className="font-semibold text-[#1E2F31]">
                          1. JVA Setup
                        </span>
                        <span className="font-bold text-[#1C6048] text-right">
                          {opCoData?.setupDetails?.jvaOpex !== undefined
                            ? opCoData.setupDetails.jvaOpex.toFixed(2)
                            : "2.50"}
                        </span>
                      </div>
                      <div className="flex justify-between font-display hover:bg-[#F9F8F6] p-0.5 px-1 rounded">
                        ...
                        <span className="font-bold text-[#1C6048] text-right">
                          {opCoData?.setupDetails?.commOpex !== undefined
                            ? opCoData.setupDetails.commOpex.toFixed(2)
                            : "15.00"}
                        </span>
                      </div>
                      <div className="flex justify-between font-display hover:bg-[#F9F8F6] p-0.5 px-1 rounded">
                        ...
                        <span className="font-bold text-[#1C6048] text-right">
                          {opCoData?.setupDetails?.workingCapitalOpex !==
                          undefined
                            ? opCoData.setupDetails.workingCapitalOpex.toFixed(
                                2,
                              )
                            : "64.67"}
                        </span>
                ...
                <div className="bg-[#1E2F31] p-3.5 rounded-xl border border-[#D8D8D8] text-[#EFEBE7]">
                  <span className="text-[9px] uppercase font-black text-[#C4DFD2] tracking-wider block mb-2">
                    Efficiency Benchmark
                  </span>
                  <div className="grid grid-cols-2 gap-2 text-[10px]">
                    <div className="border-r border-white/10">
                      <span className="block text-white/60 mb-0.5">
                        Building GFA
                      </span>
                      <span className="font-display font-bold text-white text-sm">
                        {buildArea.toLocaleString()} sqm
                      </span>
                    </div>
                    <div className="pl-1">
                      <span className="block text-white/60 mb-0.5">
                      ...
                      <span className="font-display font-bold text-white text-sm">
                        IDR{" "}
                        {costPerBedM.toLocaleString("id-ID", {
                    ...
                    <div className="col-span-2 border-t border-white/10 pt-2 mt-1 flex justify-between items-center">
                      <span className="text-white/60">
                        Const., FF&E, MedEq / sqm
                      </span>
                      <span className="font-display font-bold text-[#C4DFD2] text-xs">
                        IDR{" "}
                        {costPerSqmM.toLocaleString("id-ID", {
                  ...
                  {narrativeSteps.map((step, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-2 truncate">
                        <span
                          className={`font-bold font-display ${activeNarrativeStep === idx ? "text-[#1C6048]" : "text-[#8A8175]"}`}
                        >
                          0{idx + 1}
                        </span>
                      ...
                      <span
                        className={`w-1.5 h-1.5 rounded-full shrink-0 ${activeNarrativeStep === idx ? "bg-[#1C6048]" : "bg-transparent"}`}
                      ></span>
                    </button>
                  ))}
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-[#D8D8D8] overflow-hidden p-5 space-y-6">
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between border-b border-[#D8D8D8] pb-1.5">
                    <span className="text-[10px] uppercase font-black tracking-wider text-[#1C6048]">
                      I. Project Milestones & Scale
                    </span>
                    <span className="text-[9px] font-sans font-bold text-[#8A8175]">
                      Year 1 = 2026
                    </span>
                  </div>
                  ...
                  <div className="divide-y divide-[#D8D8D8]/40 border-b border-[#D8D8D8]/40">
                    ...
                    <div className="py-2 flex justify-between items-center hover:bg-[#F9F8F6] px-1 transition-colors">
                      <span className="text-[11px] font-medium text-[#4C4A4B]">
                        Hospital Development Phase
                      </span>
                      <span className="text-xs font-bold font-sans text-[#1E2F31]">
                        {propCoData?.assumptions?.devDurationMonths
                          ? (
                              propCoData.assumptions.devDurationMonths / 12
                            ).toFixed(1)
                          : "2.0"}{" "}
                        Years
                      </span>
                    ...
                    <div className="py-2 flex justify-between items-center hover:bg-[#F9F8F6] px-1 transition-colors">
                      ...
                      <span className="text-xs font-bold font-sans text-[#1C6048]">
                        {propCoData?.assumptions?.devDurationMonths
                          ? `Year ${Math.ceil(propCoData.assumptions.devDurationMonths / 12) + 1} (${2025 + Math.ceil(propCoData.assumptions.devDurationMonths / 12) + 1})`
                          : "Year 3 (2028)"}
                      </span>
                    </div>
                    {/* Row 3 */}
                  ...
                  <div className="pt-2">
                    <div className="flex justify-between items-center mb-1.5">
                      <span className="text-[10px] font-bold text-[#4C4A4B]">
                        Occupancy (BOR) Target Ramp
                      </span>
                      <span className="text-[10px] font-bold font-sans text-[#1C6048]">
                        {opCoData?.assumptions?.borStart
                          ? `${opCoData.assumptions.borStart}%`
                          : "45%"}{" "}
                        →{" "}
                        {opCoData?.assumptions?.borMax
                          ? `${opCoData.assumptions.borMax}%`
                          : "65%"}{" "}
                        (+
                        {opCoData?.assumptions?.borIncrement
                          ? `${opCoData.assumptions.borIncrement}%`
                          : "5%"}
                        /Yr)
                      </span>
                  ...
                  <div className="divide-y divide-[#D8D8D8]/40 border-b border-[#D8D8D8]/40 relative">
                    ...
                    >
                      <div className="flex items-center gap-1">
                        <span className="text-[11px] font-medium text-[#4C4A4B]">
                          PropCo Asset Development CapEx
                        </span>
                        <button
                          ref={buttonRef}
                          ...
                          <div className="border-b border-[#EFEBE7]/20 pb-2 mb-2 flex justify-between items-center relative z-10">
                            <div>
                              <h5 className="font-bold text-[#C4DFD2] uppercase tracking-wider text-[10px] font-display">
                                PropCo Capital Breakdown
                              </h5>
                              <p className="text-[9px] text-[#EFEBE7]/70 font-display">
                                Detailed property asset development allocations
                                in Billions
                              </p>
                            </div>
                            <button
                          ...
                          <div className="space-y-2.5 relative z-10">
                            ...
                            <div>
                              <div className="flex justify-between text-[10px] font-bold text-[#C4DFD2] uppercase tracking-wider mb-1">
                                ...
                                <span className="font-display text-[#C4DFD2]">
                                  {propCoData?.capexDetails?.totalHardCosts
                                    ? `IDR ${propCoData?.capexDetails?.totalHardCosts.toFixed(1)}B`
                                    : "N/A"}
                                </span>
                              </div>
                              <div className="pl-2 mt-0.5 space-y-1 text-[11px] text-[#EFEBE7]/80 font-display">
                                <div className="flex justify-between hover:text-white transition-colors">
                                  ...
                                  <span>
                                    {propCoData?.capexDetails?.buildCost
                                      ? `${propCoData?.capexDetails?.buildCost.toFixed(1)} B`
                                      : "0.0 B"}
                                  </span>
                                </div>
                                <div className="flex justify-between hover:text-white transition-colors">
                                  ...
                                  <span>
                                    {propCoData?.capexDetails?.medEqCost
                                      ? `${propCoData?.capexDetails?.medEqCost.toFixed(1)} B`
                                      : "0.0 B"}
                                  </span>
                                </div>
                                <div className="flex justify-between hover:text-white transition-colors">
                                  ...
                                  <span>
                                    {propCoData?.capexDetails?.infraCost
                                      ? `${propCoData?.capexDetails?.infraCost.toFixed(1)} B`
                                      : "0.0 B"}
                                  </span>
                                </div>
                                <div className="flex justify-between hover:text-white transition-colors">
                                  ...
                                  <span>
                                    {propCoData?.capexDetails?.ffeCost
                                      ? `${propCoData?.capexDetails?.ffeCost.toFixed(1)} B`
                                      : "0.0 B"}
                                  </span>
                                </div>
                              </div>
                            ...
                            <div className="pt-1.5 border-t border-[#EFEBE7]/15">
                              <div className="flex justify-between text-[10px] font-bold text-[#C4DFD2] uppercase tracking-wider mb-1">
                                ...
                                <span className="font-display text-[#C4DFD2]">
                                  {propCoData?.capexDetails?.totalSoftCosts
                                    ? `IDR ${propCoData?.capexDetails?.totalSoftCosts.toFixed(1)}B`
                                    : "N/A"}
                                </span>
                              </div>
                              <p className="text-[9.5px] text-[#EFEBE7]/70 pl-2 leading-normal">
                                Includes VAT{" "}
                                {propCoData?.capexDetails?.vatCost
                                  ? `(${propCoData?.capexDetails?.vatCost.toFixed(1)} B)`
                                  : ""}
                                , municipal licenses, startup G&A, localized
                                builder insurance (Dev CAR), consultant fees{" "}
                                {propCoData?.capexDetails?.consultantCost
                                  ? `(${propCoData?.capexDetails?.consultantCost.toFixed(1)} B)`
                                  : ""}
                                , and pre-operating contingency pools.
                              </p>
                            </div>
                            ...
                            <div className="pt-1.5 border-t border-[#EFEBE7]/15 flex justify-between text-[10px] font-bold text-[#C4DFD2] uppercase tracking-wider">
                              ...
                              <span className="font-display text-[#C4DFD2]">
                                {propCoData?.capexDetails?.landCost
                                  ? `IDR ${propCoData?.capexDetails?.landCost.toFixed(1)}B`
                                  : "0.0 B"}
                              </span>
                            </div>
                          </div>
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between border-b border-[#D8D8D8] pb-1.5">
                    <span className="text-[10px] uppercase font-black tracking-wider text-[#1C6048]">
                      III. Yields, Returns & Performance
                    </span>
                    <span className="text-[9px] font-sans font-bold text-[#8A8175]">
                  ...
                  <div className="grid grid-cols-2 gap-x-6 gap-y-3.5 pt-1 font-sans">
                    ...
                    <div className="flex flex-col bg-[#1C6048]/5 p-2 rounded-xl border border-[#1C6048]/15 hover:bg-[#1C6048]/10 transition-colors">
                      <span className="text-[8.5px] uppercase font-extrabold text-[#1C6048] tracking-widest">
                        Blended Base IRR
                      </span>
                      <span className="text-sm font-black text-[#1C6048] mt-0.5">
                        {currentBlendedIrr}
                      </span>
                    </div>
                    ...
                    <div className="flex flex-col bg-[#1E2F31]/5 p-2 rounded-xl border border-[#1E2F31]/10 hover:bg-[#1E2F31]/10 transition-colors">
                      <span className="text-[8.5px] uppercase font-extrabold text-[#4C4A4B] tracking-widest">
                        Payback Period
                      </span>
                      <span className="text-sm font-black text-[#1E2F31] mt-0.5">
                        {currentPaybackText}
                      </span>
                    </div>
                  </div>
