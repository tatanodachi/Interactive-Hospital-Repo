...
export const LifetimePnLTable: React.FC<LifetimePnLTableProps> = ({
  ...
  if (activeSegment === "propco") {
    ...
    advisoryText = "PSAK Advisory: Pre-opening development expenses (Dev G&A, Dev CAR) may require immediate expense treatment per PSAK 19. They are currently captured in PropCo expenses prior to operations.";
  } else {
    // OpCo Revenue
