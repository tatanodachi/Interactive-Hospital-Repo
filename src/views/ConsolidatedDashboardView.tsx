            ...
            <div className="flex flex-col gap-2">
              ...
              {holdCoAssumptions?.includeFinancing && (
                <div className="pl-5 flex flex-col gap-2 mt-1">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] text-[#4C4A4B]">LTV Ratio (%)</span>
                    <input
                      type="number"
                      className="w-16 bg-white border border-[#D8D8D8] rounded px-2 py-1 text-[10px] text-right text-[#1E2F31] font-bold"
                      value={holdCoAssumptions?.ltvRatio || 0}
                      onChange={(e) => handleHoldCoChange("ltvRatio", parseFloat(e.target.value))}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] text-[#4C4A4B]">Interest Rate (%)</span>
                    <input
                      type="number"
                      className="w-16 bg-white border border-[#D8D8D8] rounded px-2 py-1 text-[10px] text-right text-[#1E2F31] font-bold"
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] text-[#4C4A4B]">Loan Tenor (Yrs)</span>
                    <input
                      type="number"
                      className="w-16 bg-white border border-[#D8D8D8] rounded px-2 py-1 text-[10px] text-right text-[#1E2F31] font-bold"
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] text-[#4C4A4B]">IO Grace Period (Yrs)</span>
                    <input
                      type="number"
                      className="w-16 bg-white border border-[#D8D8D8] rounded px-2 py-1 text-[10px] text-right text-[#1E2F31] font-bold"
