...
import { 
  useMonthlyColumns, OPCO_FORMULAS, PROPCO_FORMULAS, CONSOLIDATED_FORMULAS, formatCurrency, formatNumber, formatPercent,
...
extractView('OpCoDashboardView', 'OpCoDashboardView');
extractView('PropCoDashboardView', 'PropCoDashboardView');
extractView('ConsolidatedDashboardView', 'ConsolidatedDashboardView');
extractView('OpCoSettingsView', 'OpCoSettingsView');
extractView('PropCoSettingsView', 'PropCoSettingsView');
